...
NODE_CLASS_MAPPINGS = {
    "ColourStyler": ColourStyler,
    "ColourStylerAdvanced": ColourStylerAdvanced,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "ColourStyler": "Colour Styler",
    "ColourStylerAdvanced": "Colour Styler Advanced",
}